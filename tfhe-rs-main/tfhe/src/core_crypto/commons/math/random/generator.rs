...
//use concrete_csprng::generators::{BytesPerChild, ChildrenCount, ForkError};Farhad commented
use rayon::prelude::*;

//pub use concrete_csprng::generators::{Farhad commented
//    ParallelRandomGenerator as ParallelByteRandomGenerator, RandomGenerator as ByteRandomGenerator,Farhad commented
//};Farhad commented
//pub use concrete_csprng::seeders::{Seed, Seeder};Farhad commented
...
pub mod serialization_proxy {
    //pub(crate) use concrete_csprng::seeders::Seed; Farhad commented
